...
{
    public class ExpanderRadio : RadioButton
    {
        public ExpanderRadio()
        {
            DefaultStyleKey = typeof(ExpanderRadio);
        ...
        public static readonly DependencyProperty TargetProperty =
            DependencyProperty.Register("Target", typeof(UIElement), typeof(ExpanderRadio), new PropertyMetadata(null, PropertyChangedCallback));

        private static void PropertyChangedCallback(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            (d as ExpanderRadio).HandleChange();
        } 
    }
}