...
namespace CodeValue.CodeLight.Mvvm.RelativeBinding
{
    ...
    public static class BindingHelper
    {
        ...
        private static void CreateBinding(FrameworkElement targetElement, object sourceElement, RelativeSourceBinding bindingConfiguration)
        {
            ...
            {
                Binding binding = CreateBindingFromConfiguration(sourceElement,  bindingConfiguration);
        ...
        public static Binding CreateBindingFromConfiguration(object sourceElement, RelativeSourceBinding bindingConfiguration)
        {
